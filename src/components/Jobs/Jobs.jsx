        ...
        <div className='my-[20px]'>
            <Card className="px-[2rem] pt-[2rem] pb-[5.5rem]">
                <div className='flex items-center justify-between'>
                    <h1 className='text-Medium+/Title/Small '>{data.businessId} <span className='text-Medium+/SubTitle/Small text-fourth ml-[1.375rem] text-center'>Management-Catalysts</span></h1>
